...
let ProductsController = class ProductsController {
    ...
    addProduct(prodTitle, prodDesc, prodDue) {
    ...
    updateProduct(prodId, prodTitle, prodDesc, prodDue) {
...
__decorate([
    ...
    __param(2, common_1.Body('due_date')),
...
__decorate([
    ...
    __param(2, common_1.Body('descipriton')),
    __param(3, common_1.Body('due_date')),
    __metadata("design:type", Function),
